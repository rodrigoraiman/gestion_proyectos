...
class ProyectosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post proyectos_url, params: { proyecto: { date_end: @proyecto.date_end, date_start: @proyecto.date_start, description: @proyecto.description, estado: @proyecto.estado, name: @proyecto.name } }
    end
  ...
  test "should update proyecto" do
    patch proyecto_url(@proyecto), params: { proyecto: { date_end: @proyecto.date_end, date_start: @proyecto.date_start, description: @proyecto.description, estado: @proyecto.estado, name: @proyecto.name } }
